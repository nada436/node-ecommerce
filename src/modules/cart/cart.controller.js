...
import { add_product, get_cart, quantity_adjustment, remove_product } from "./cart.service.js";
...
cart_routes.patch('/quantity_adjustment/:productId',auth,catchAsync(quantity_adjustment))